    ...
    <div id="multi-search-results-placeholder">
      ...
      <div>
        ...
        <div>
          <ul>
            <li>
              <span>simple:</span> (implied) — search in video titles, channel
              names and playlist titles
            </li>
            <li>
              <span>video:</span> — search in video titles, tags and category
              field
              <ul>
                <li>
                ...
                <li>
                  <span>active:</span>
                  <span className="value">yes/no</span> — whether the video is
            ...
            <li>
              ...
              <ul>
                <li>
                  <span>lang:</span> — subtitles language (use two-letter ISO
                  country code, same as the one from settings page)
                </li>
                <li>
                  <span>source:</span>
                  <span className="value">auto/user</span> — <i>auto</i> to
                  search though auto-generated subtitles only, or <i>user</i> to
                  search through user-uploaded subtitles only
                </li>
              </ul>
            </li>
          </ul>
