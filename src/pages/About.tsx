    ...
    return (
        <div className="boxed-content">
            ...
            <div className="about-section">
                <h2>Useful Links</h2>
                <p>
                    This project is in active and constant development, take a
                    look at the{' '}
                    <a
                        href="https://github.com/tubearchivist/tubearchivist#roadmap"
                        target="_blank"
                    >
                        roadmap
                    </a>{' '}
                ...
                <p>
                    ...
                    <a
                        href="https://github.com/tubearchivist/tubearchivist/issues"
                        target="_blank"
                    >
                        issue
                    </a>{' '}
                    ...
                    <a
                        href="https://www.tubearchivist.com/discord"
                        target="_blank"
                    >
                        Discord
                    </a>{' '}
            ...
            <div className="about-section">
                ...
                <p>
                    ...
                    , if you want to buy the developer a coffee. Thank you for
                    your support!
                </p>
            </div>
        </div>
