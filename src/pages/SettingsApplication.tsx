          ...
          <div className="settings-group">
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.subscriptions.channel_size}
                </span>
              </p>
              <i>
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.subscriptions.live_channel_size}
                </span>
              </p>
              <i>
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.subscriptions.shorts_channel_size}
                </span>
              </p>
              <i>
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.subscriptions.auto_start}
                </span>
              </p>
              <i>
                Enable this will automatically start and prioritize videos from
                your subscriptions.
              </i>
              <br />
              <select
          ...
          <div className="settings-group">
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.downloads.limit_speed}
                </span>
              </p>
              <i>
                Limit download speed. 0 (zero) to deactivate, e.g. 1000 (1MB/s).
                Speeds are in KB/s. Setting takes effect on new download jobs or
                application restart.
              </i>
              <br />
              <input
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.downloads.throttledratelimit}
                </span>
              </p>
              <i>
                Download will restart if speeds drop below specified amount. 0
                (zero) to deactivate, e.g. 100. Speeds are in KB/s.
              </i>
              <br />
              <input
                type="number"
            ...
            <div className="settings-item">
              ...
              <i>
                Seconds to sleep between calls to YouTube. Might be necessary to
                avoid throttling. Recommended 3.
              </i>
              <br />
              <input
                type="number"
            ...
            <div className="settings-item">
              <p>
                <span className="danger-zone">Danger Zone</span>: Current auto
                delete watched videos:{" "}
                <span className="settings-current">
                  {config.downloads.autodelete_days}
                </span>
              </p>
              <i>
          ...
          <div className="settings-group">
            ...
            <div className="settings-item">
              ...
              <ul>
                ...
                <li>
                  ...
                  : Max 1080p video height with iOS compatible video and audio
                  codecs.
                </li>
                <li>
                  <span className="settings-current">0</span>: deactivate and
                  download the best quality possible as decided by yt-dlp.
                </li>
              </ul>
              <i>
                Make sure your custom format gets merged into a single file.
                Check out the{" "}
                <a
            ...
            <div className="settings-item">
              <p>
                ...
                Currently:{" "}
                <span className="settings-current">
                  {config.downloads.format_sort}
                </span>
              </p>
              <p>Example configurations:</p>
              <ul>
                <li>
                  <span className="settings-current">res,codec:av1</span>:
                  prefer AV1 over all other video codecs.
                </li>
                <li>
                  <span className="settings-current">0</span>: deactivate and
                  keep the default as decided by yt-dlp.
                </li>
              </ul>
              <i>
                Not all codecs are supported by all browsers. The default value
                ensures best compatibility. Check out the{" "}
                <a
                  href="https://github.com/yt-dlp/yt-dlp#sorting-formats"
                  target="_blank"
                >
                  documentation
                </a>{" "}
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.downloads.extractor_lang}
                </span>
              </p>
              <i>
                This will change the language this video gets indexed as. That
                will only be available if the uploader provides translations.
                Add as two letter ISO language code, check the{" "}
                <a
                  href="https://github.com/yt-dlp/yt-dlp#youtube"
                  target="_blank"
                >
                  documentation
                </a>{" "}
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.downloads.add_thumbnail}
                </span>
              </p>
          ...
          <div className="settings-group">
            ...
            <div className="settings-item">
              <p>
                ...
                <br />
                <i>
                  Choose which subtitles to download, add comma separated
                  language codes,
                  <br />
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.downloads.subtitle_source}
                </span>
              </p>
              <i>
                Download only user generated, or also less accurate auto
                generated subtitles.
              </i>
              <br />
              <select
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.downloads.subtitle_index}
                </span>
              </p>
              <i>
                Store subtitle lines in Elasticsearch. Not recommended for
                low-end hardware.
              </i>
              <br />
              <select
          ...
          <div className="settings-group">
            ...
            <div className="settings-item">
              <p>
                ...
                <ul>
                  <li>
                    <span className="settings-current">all,100,all,30</span>:
                    Get 100 max-parents and 30 max-replies-per-thread.
                  </li>
                  <li>
                    <span className="settings-current">1000,all,all,50</span>:
                    Get a total of 1000 comments over all, 50 replies per
                    thread.
                  </li>
                </ul>
                <input
          ...
          <div className="settings-group">
            ...
            <div className="settings-item">
              ...
              <p>
                ...
                <a
                  href="https://github.com/tubearchivist/browser-extension"
                  target="_blank"
                >
                  browser extension
                </a>
              ...
              <i>
                ...
                <span className="settings-current">cache/import</span> before
                enabling. Instructions in the{" "}
                <a
          ...
          <div className="settings-group">
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.downloads.integrate_ryd}
                </span>
              </p>
              <i>
                Before activating that, make sure you have a scraping sleep
                interval of at least 3 secs set to avoid ratelimiting issues.
              </i>
              <br />
              <select
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.downloads.integrate_sponsorblock}
                </span>
              </p>
              <i>
                Before activating that, make sure you have a scraping sleep
          ...
          <div className="settings-group">
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {config.application.enable_snapshot}
                </span>
              </p>
              <i>
                Automatically create daily deduplicated snapshots of the index,
                stored in Elasticsearch. Read first before activating:{" "}
                <a
                  target="_blank"
                    ...
                    snapshots.snapshots.map((snapshot, index) => {
                      return (
                        <p key={index}>
                          ...
                          , took{" "}
                          <span className="settings-current">
                            {snapshot.duration_s}s
                          </span>{" "}
                          to create. State: <i>{snapshot.state}</i>
                        </p>
                      );
                    })}
                </>
