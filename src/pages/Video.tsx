                ...
                {sponsorblock.is_enabled && (
                    <>
                        {sponsorblock.segments.length == 0 && (
                            <h4>
                                This video doesn't have any sponsor segments
                                added. To add a segment go to{' '}
                                <u>
                                    <a
                ...
                <div className="info-box info-box-2">
                    ...
                    <div className="info-box-item">
                        {video.media_size && (
                            <p>
                                File size:{' '}
                                {humanFileSize(video.media_size, true)}
                            </p>
                        )}
