      ...
      <div className="boxed-content">
        ...
        <div className="title-bar">
          ...
          <div className="settings-group">
            <p>
              Schedule settings expect a cron like format, where the first value
              is minute, second is hour and third is day of the week.
            </p>
            <p>Examples:</p>
            <ul>
              <li>
                <span className="settings-current">0 15 *</span>: Run task every
                day at 15:00 in the afternoon.
              </li>
              <li>
                <span className="settings-current">30 8 */2</span>: Run task
                every second day of the week (Sun, Tue, Thu, Sat) at 08:30 in
                the morning.
              </li>
              <li>
                <span className="settings-current">auto</span>: Sensible
                default.
              </li>
            </ul>
            <p>Note:</p>
            <ul>
              <li>
                Avoid an unnecessary frequent schedule to not get blocked by
                YouTube. For that reason, the scheduler doesn't support
                schedules that trigger more than once per hour.
              </li>
            </ul>
          </div>
        </div>
        <form
          action="{% url 'settings_scheduling' %}"
          method="POST"
        ...
        >
          <div className="settings-group">
            ...
            <div className="settings-item">
              <p>
                ...
                to get access to{" "}
                <span className="settings-current">real time</span>{" "}
                notifications for new videos uploaded by your favorite channels.
              </p>
              <p>
          ...
          <div className="settings-group">
            ...
            <div className="settings-item">
              <p>
                ...
                <span className="settings-current">
                  {check_reindex.task_config.days}
                </span>
              </p>
              ...
              <input
                type="number"
                name="check_reindex_days"
                id="id_check_reindex_days"
              />
            </div>
          </div>
          <div className="settings-group">
          ...
          <div className="settings-group">
            ...
            <div className="settings-item">
              <p>
                <i>
                  Zip file backups are very slow for large archives and
                  consistency is not guaranteed, use snapshots instead. Make
                  sure no other tasks are running when creating a Zip file
                  backup.
                </i>
              </p>
              <p>
            ...
            <div className="settings-item">
              ...
              <input
                type="number"
                name="run_backup_rotate"
                id="id_run_backup_rotate"
              />
            </div>
          </div>
          <div className="settings-group">
            ...
            <div className="settings-item">
              ...
              <select name="task" id="id_task" defaultValue="">
                ...
                <option value="update_subscribed">
